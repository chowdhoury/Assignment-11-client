...
const Navbar = () => {
    const navLinks = (
      <>
        ...
        <li>
          <NavLink to="/books" className="hover:text-primary duration-300">Books</NavLink>
        </li>
        <li>
          <NavLink to="/request" className="hover:text-primary duration-300">Request</NavLink>
        </li>
        <li>
          <NavLink to="/dashboard" className="hover:text-primary duration-300">Dashboard</NavLink>
        </li>
      </>
    );
    return (
